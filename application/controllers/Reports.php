...
//            $pdf->Line(1, 1, 1, 53);
            ...
            $html1 = '
                        ...
                        <tr>
                            <td width="75%">
                                <table style="padding-left:3px;">
                                    ...
                                    <tr><td colspan="3" style="font-size:3px;"></td></tr>
                                    <tr style="font-weight: bold; color:#2c97d1;">
                                        <td>SPECIES </td>
                                        <td>:</td>
                ...
                $htm1_headerTexts = '<p style="font-size:8px; color:white;"><b>ZV - Gemstone Identification Report</b></p>';
                $pdf->SetFillColor(44,151,209);
