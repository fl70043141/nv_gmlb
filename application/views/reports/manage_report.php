            ...
            $('.thumbnail').click(function(){ 
              ...
              function get_variety_drpdwn(){
                  var idnfcn_id = parseInt($('#identification').val()); 
                    $.ajax({
                           url: "<?php echo site_url('reports/test');?>",
                           type: 'post',
                                     ...
                                     <div class="col-md-6">
                                                ...
                                                <div hidden class="form-group">
                                                    ...
                                                    <div class="col-md-9">                                            
                                                        <div class="input-group">
                                                             <label class="switch  switch-small">
                                                                <!--<input type="checkbox"  value="0">-->
                                                                <?php echo form_checkbox('sync_required', set_value('sync_required','1'),1, 'id="sync_required" placeholder=""'.$dis.' '.$o_dis.' '); ?>
                                         ...
                                         <hr> 
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">    
                                                    <?php echo form_input('weight', set_value('weight',$result['weight']), 'id="weight" class="form-control" placeholder="Enter Carat Weight"'.$dis.' '.$o_dis.' '); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">    
                                                    <?php echo form_input('dimension', set_value('dimension',$result['dimension']), 'id="dimension" class="form-control" placeholder="Enter Dimension of Stone"'.$dis.' '.$o_dis.' '); ?>
                                       ...
                                       <hr>         
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">  <?php echo form_dropdown('comments1',$comments_list, set_value('comments1'),' class="form-control select" data-live-search="true" id="comments1" '.$o_dis.'');?> 
                                                       ...
                                                       <div class="input-group"> 
                                                            <?php echo form_textarea(array('name'=>'comments','rows'=>'4','cols'=>'60','id'=>'comments', 'class'=>'form-control', 'placeholder'=>'Enter comments' ),set_value('comments',$result['comments']),$dis.' '.$o_dis.' '); ?>
                                                       </div>  
